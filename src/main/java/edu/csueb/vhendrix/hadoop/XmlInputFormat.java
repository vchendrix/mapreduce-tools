...
public class XmlInputFormat extends TextInputFormat
{
    ...
    {
        RecordReader<LongWritable, Text> rr = null;
        rr = new XmlRecordReader();
        try
        {
            ...
            RecordReader<LongWritable, Text>
    {
                ...
                throws IOException, InterruptedException
        {
            if (split instanceof FileSplit)
            {
                ...
                startTag = context.getConfiguration().get(START_TAG_KEY)
                        .getBytes("utf-8");
                endTag = context.getConfiguration().get(END_TAG_KEY)
                        .getBytes("utf-8");
